...
lp_mtx = np.array([
    [-(9*single_node_fail_rate_year), single_rp_rate_year, 0.0, 0.0],
    [9*single_node_fail_rate_year, -(8*single_node_fail_rate_year+single_rp_rate_year), multi_rp_rate_year, 0.0],
    [0.0, 8*single_node_fail_rate_year, -(7*single_node_fail_rate_year+multi_rp_rate_year), multi_rp_rate_year],
    [0.0, 0.0, 7*single_node_fail_rate_year, -(6*single_node_fail_rate_year+multi_rp_rate_year)]
    ])

right = np.array([-1, 0.0, 0.0, 0.0])
