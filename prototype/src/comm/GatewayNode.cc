#include "GatewayNode.hh"

GatewayNode::GatewayNode(uint16_t _self_conn_id, Config &_config) : Node(_self_conn_id, _config)
{
...
void GatewayNode::start()
{
}

void GatewayNode::stop()
{
}
